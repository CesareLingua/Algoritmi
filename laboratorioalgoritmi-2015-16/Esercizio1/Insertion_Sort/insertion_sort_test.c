...
void test_insertion_sort_on_null_array() {
  ...
  assert(1);
  printf("test_insertion_sort_on_null_array: OK\n");
}

void test_insertion_sort_on_full_array_long(long int* array, int n_records) {
  //long int array[7] = { 11, 4, 1, -8, 10, 9, 15};
  int i;
  time_t m;
  time_t now = time(NULL);

  insertion_sort((void**) array, n_records , compare_long_int);
  m = difftime(time(NULL), now);
  for(i=0; i<6; ++i)
    assert(array[i] <= array[i+1]);

  printf("test_insertion_sort_on_full_array_long: OK\n");
...
void test_insertion_sort_on_equals_array(){
	...
	printf("test_insertion_sort_on_equals_array: OK\n");	
}
...
void test_insertion_sort_on_full_array_double(){
	...
	printf("test_insertion_sort_on_full_array_float: OK\n");
}
 ...
 */
  ...
  test_insertion_sort_on_full_array_long(array_long_int, n_records);
  test_insertion_sort_on_equals_array();
  //test_insertion_sort_on_full_array_double(array_double);
  //test_insertion_sort_on_char_array(array_string);
